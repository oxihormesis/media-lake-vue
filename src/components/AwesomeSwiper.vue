      ...
      >
        ...
        <swiper-slide v-for="item in mediaItems" :key="item.id">
          <div style="text-align: center">
            ...
            />
            <fit-text class="hero_title" :max="9">{{ item.name || item.title }}</fit-text>
          </div>
        </swiper-slide>
...
import { Swiper as SwiperClass, Navigation, Pagination, Autoplay, Mousewheel } from "swiper/js/swiper.esm";
